...
<section>
    <div class="imageContainer l-aboutus-imageHeader">
                ...
                <div class="col-12">
                    ...
                    <div class="row m-downArrow mt-md-5">
                        <div class="col-md-12 col-12">
                            <div class="mt-md-5"><i class="fa fa-chevron-down" aria-hidden="true"></i></div>
                        </div>
                    </div>
                </div>
            </div>
...
<div class="container">
    <div class="row mt-5">
        <div class="col-12 mt-1">
            <h1 class="dinar-title text-center green-text">درباره ما</h1>
            <hr style="width: 20%" class="green-line-theme">
            <p class="text-center paragraph-lineHeight mt-4">تکنولوژی به حدی پیشرفت کرده که دیگر می توان بازی های دوران کودکی را وارد دنیای واقعی <br>
                کرد. شاید نسخه واقعیت افزوده بازی سوپرماریو چیزی دور از انتظار بود، اما اطلاعات منتشر شده<br>
                از آن نه تنها گیمرها بلکه تمام طرفداران تکنولوژی را شگفت زده کرده است. Abhishek Singh،
            </p>

            <div class="row justify-content-center">
                <div class="col-auto">
                    <div class="border-theme p-3">
                        <h4 class="dinar-title text-center">پارک علم و فناوری بندری انزلی</h4>
                        <h5 class="text-center mt-4">گروه نرم افزاری ایمگنا</h5>
                        <h5 class="dinar-title-thin text-center mt-4">۰۹۱۱-۲۳۴-۴۴۴۴</h5>
                        <h5 class="text-center mt-4">info@imagna.com</h5>
                    </div>
                </div>
            </div>
